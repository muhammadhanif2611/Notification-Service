 ...
 * Sesuai DESIGN.md: Sidebar Fixed Nav, 240px, sticky top-0 h-screen.
 * @returns {JSX.Element}
 */
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 sticky top-0 h-screen flex flex-col border-r border-[var(--neutral-border)] bg-[var(--neutral-surface)]">
      ...
      {/* Footer */}
      <div className="px-5 py-4 border-t border-[var(--neutral-border)]">
        <p className="text-[10px] text-[var(--text-muted)]">v1.0.0 — Alpha</p>
      </div>
    </aside>
  );
}
